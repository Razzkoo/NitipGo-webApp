...
const mockUsers: User[] = [
  { id: 1, name: "Budi Santoso", email: "budi@email.com", phone: "0812-3456-7890", type: "customer", status: "active", joinDate: "10 Jan 2024", orders: 12 },
  { id: 2, name: "Andi Pratama", email: "andi@email.com", phone: "0813-4567-8901", type: "traveler", status: "active", joinDate: "5 Jan 2024", trips: 45 },
  { id: 3, name: "Sari Dewi", email: "sari@email.com", phone: "0814-5678-9012", type: "traveler", status: "pending", joinDate: "14 Feb 2024", trips: 0 },
  { id: 4, name: "Rina Kusuma", email: "rina@email.com", phone: "0815-6789-0123", type: "customer", status: "cancelled", joinDate: "20 Dec 2023", orders: 3 },
  { id: 5, name: "Dimas Wijaya", email: "dimas@email.com", phone: "0816-7890-1234", type: "admin", status: "active", joinDate: "1 Feb 2024", orders: 0 },
  { id: 6, name: "Putri Lestari", email: "putri@email.com", phone: "0817-2222-3333", type: "customer", status: "pending", joinDate: "18 Feb 2024", orders: 0 },
  { id: 7, name: "Ahmad Fauzi", email: "ahmad@email.com", phone: "0818-4444-5555", type: "traveler", status: "cancelled", joinDate: "22 Jan 2024", trips: 2 },
  { id: 8, name: "Nabila Rahma", email: "nabila@email.com", phone: "0819-6666-7777", type: "customer", status: "active", joinDate: "11 Feb 2024", orders: 7 },
];
...
const roleColors: Record<UserType, string> = {
  ...
  traveler: "bg-emerald-50 text-emerald-700 border border-emerald-100",
...
export default function AdminUsers() {
  ...
  const handleSaveEdit = () => {
    ...
    setUsers((prev) => prev.map((u) => u.id === editingUser.id ? { ...u, name: editFormData.name, phone: editFormData.phone, type: editFormData.role as UserType } : u));
    ...
    <DashboardLayout role="admin">
      <div className="p-6 md:p-8 lg:p-10 space-y-6">
        ...
        <div className="flex items-start justify-between">
          ...
          <Button onClick={() => setAddUserOpen(true)}>+ Tambah User</Button>
        </div>
        ...
        <div className="rounded-2xl border border-zinc-100 bg-white p-4 shadow-sm space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="space-y-1.5 flex-1">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <FilterChip label={`Traveler (${countByRole("traveler")})`} active={roleFilter === "traveler"} onClick={() => setRoleFilter("traveler")} />
          ...
          {activeFilterCount > 0 && (
            <div className="flex items-center gap-2 pt-1 border-t border-zinc-100">
              ...
              <button onClick={() => { setRoleFilter("all"); setStatusFilter("all"); }} className="ml-auto text-xs text-zinc-400 hover:text-zinc-700 transition">
                Reset semua
              </button>
            </div>
          )}
              ...
              <table className="w-full min-w-[700px]">
                <thead>
                  <tr className="border-b border-zinc-100">
                    <th className="px-5 py-3 text-left text-xs font-semibold text-zinc-400 uppercase tracking-wide w-[30%]">Pengguna</th>
                    ...
                    <th className="px-4 py-3 text-center text-xs font-semibold text-zinc-400 uppercase tracking-wide w-[12%]">Aktivitas</th>
                    <th className="px-4 py-3 text-center text-xs font-semibold text-zinc-400 uppercase tracking-wide w-[20%]">Aksi</th>
                  </tr>
                </thead>
                        ...
                        <div className="flex justify-center gap-1">
                          {user.status === "pending" ? (
                            ...
                            <>
                              ...
                              <ActionBtn icon={Ban} title={user.type === "admin" ? "Admin tidak bisa di-suspend" : "Suspend"} disabled={user.type === "admin"} color="amber" onClick={() => setSuspendUser(user)} />
        ...
        <Dialog open={!!detailUser} onOpenChange={() => setDetailUser(null)}>
          <DialogContent className="max-w-md p-0 overflow-hidden">
            {detailUser && (
              <>
                {/* Header strip */}
                <div className={`px-6 pt-6 pb-4 ${avatarColors[detailUser.type]} bg-opacity-20`}
                  style={{ background: detailUser.type === "traveler" ? "rgb(236,253,245)" : detailUser.type === "admin" ? "rgb(245,243,255)" : "rgb(239,246,255)" }}
                >
                ...
                <div className="px-6 py-5 space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <InfoRow
                      icon={Activity}
                      label="Aktivitas"
                      value={detailUser.type === "traveler" ? `${detailUser.trips} trip` : `${detailUser.orders} order`}
                    />
        ...
        <Dialog open={addUserOpen} onOpenChange={() => setAddUserOpen(false)}>
          <DialogContent className="max-w-md">
            ...
            <div className="space-y-4 py-2">
              <FormField label="Nama Lengkap" icon={Users}>
          ...
          <DialogContent className="max-w-md">
            ...
            {editingUser && (
              <div className="space-y-4 py-2">
                ...
                <FormField label="Nama Lengkap" icon={Users}>
                  <Input placeholder="Nama" value={editFormData.name}
                    onChange={(e) => setEditFormData({ ...editFormData, name: e.target.value })}
                    className="h-10 rounded-xl border-zinc-200" />
                </FormField>
                <FormField label="Email" icon={Mail}>
                  <Input value={editingUser.email} disabled className="h-10 rounded-xl border-zinc-200 bg-zinc-50 cursor-not-allowed text-zinc-400" />
                </FormField>
                <div className="grid grid-cols-2 gap-3">
                  <FormField label="No. Telepon" icon={Phone}>
                    <Input placeholder="0812-xxxx-xxxx" value={editFormData.phone}
